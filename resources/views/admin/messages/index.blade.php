...
<head>
    ...
    <style>
        ...
        .badge-status { padding: 6px 12px; border-radius: 999px; font-size: 5px; font-weight: 400; }
        ...
        <div class="content">
            <div class="page-header">
                <div>
                    ...
                    <p class="text-muted mb-0">Tampilan pesan pengguna yang dikirim melalui landing page.</p>
                </div>
                <span class="badge badge-primary py-2 px-3">{{ $messages->count() }} Pesan</span>
            </div>
                            ...
                            <tbody>
                                @forelse($messages as $message)
                                    <tr>
                                        ...
                                        <td>{{ $message->name }}</td>
                                        <td>{{ $message->email }}</td>
                                        <td>{{ ucfirst($message->recipient) }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-5 text-muted">Belum ada pesan masuk.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
